...
const HourlyBooking = () => {
  return (
    <div className="p-6 font-[Poppins]">
      <h1 className="text-4xl font-bold text-base-content mb-8">Hourly Trips</h1>

      <div className="space-y-6">
        {hourlyTrips.map((trip) => (
          <div
            key={trip.id}
